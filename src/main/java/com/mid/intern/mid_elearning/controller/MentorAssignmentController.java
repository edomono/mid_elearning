...
public class MentorAssignmentController {
    ...
    @ResponseBody
    public ResponseEntity<Assignment> getAssignmentDetailsForCourseJson(
        ...
        assignment.getSubmissions().size(); // Initialize submissions to avoid lazy loading issues
        return ResponseEntity.ok(assignment);
    }
    ...
    // ==============================================================
    @GetMapping("/course/{courseId}/assignments/add")
    public String showAddAssignmentForm(@PathVariable("courseId") Long courseId, Model model) {
        model.addAttribute("assignment", new Assignment());
        model.addAttribute("courseId", courseId);
        return "mentor/add-assignment";
    }
